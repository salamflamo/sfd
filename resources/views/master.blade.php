    ...
    <div class="container">
        ...
        <div class="row text-center">
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                      <div class="timeline-image">
                        <img class="img-circle img-responsive" src="img/sfd/icon/workshop.jpg">
            ...
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                      <div class="timeline-image">
                        <img class="img-circle img-responsive" src="img/sfd/icon/speaker.png">
                      </div>
                    </span>
            ...
            <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                      <div class="timeline-image">
                        <img class="img-circle img-responsive" src="img/sfd/icon/festival.png">
                      </div>
                    </span>
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="team-member">
                    <img width="200px" height="200px" src="img/sfd/pembicara/dikyarga.jpg" class="img-responsive img-circle" alt="">
            ...
            <div class="col-sm-6">
                <div class="team-member">
                    <img width="200px" height="200px" src="img/sfd/pembicara/rezafaizarahman.png" class="img-responsive img-circle" alt="">
